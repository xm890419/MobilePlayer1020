...
import custom.atguigu.mobileplayer1020.view.VitamioVideoView;
...
public class VitamioVideoPlayerActivity extends Activity implements View.OnClickListener {
     ...
     * <br />
     * Auto-created on 2017-01-09 16:43:50 by Android Layout Finder
    ...
    private void setVideoType(int videoTypeDefault) {
        switch (videoTypeDefault){
            case VIDEO_TYPE_FULL:
                ...
                //把按钮设置-默认
                btnSwichScreen.setBackgroundResource(R.drawable.btn_screen_defalt_selector);
                break;
        ...
        if(mediaItems != null && mediaItems.size()>0){
            ...
            if(position < mediaItems.size()){
                ...
                if(position ==mediaItems.size()-1){
                    Toast.makeText(this, "最后一个视频了哦", Toast.LENGTH_SHORT).show();
                }
            }else {
                //越界
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            /*mp.setOnSeekCompleteListener(new MediaPlayer.OnSeekCompleteListener() {
                ...
                public void onSeekComplete(MediaPlayer mp) {
                    Toast.makeText(VitamioVideoPlayerActivity.this, "拖动完成了", Toast.LENGTH_SHORT).show();
                }
            });*/
            //准备好的时候
